...
namespace ManagedBass
{
    ...
    public struct DeviceInfo
    {
        ...
        /// </summary>
        public bool IsDefault => flags.Has(DeviceInfoFlags.Default);

        /// <summary>
        /// The device is enabled and can be used.
        /// </summary>
        public bool IsEnabled => flags.Has(DeviceInfoFlags.Enabled);

        /// <summary>
        /// The device is already initialized.
        /// </summary>
        public bool IsInitialized => flags.Has(DeviceInfoFlags.Initialized);
        
        /// <summary>
        /// The device is a Loopback device.
        /// </summary>
        public bool IsLoopback => flags.Has(DeviceInfoFlags.Loopback);
